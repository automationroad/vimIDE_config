...
# Last Changed: 2018-10-04 14:48:10
...
# 配置vim
cp -f vimIDE_config/second/.vimrc ~/.vimrc
cp -f vimIDE_config/second/.vimrc.bundles ~/.vimrc.bundles
mkdir -p ~/.vim/vim_header_model
cp -f vimIDE_config/second/vim_header ~/.vim/vim_header_model/vim_header
# 安装vim插件
